...
* ------------------------------------------------------------------------------------------------
*/
static Accelerometer_States_t accSensorState;
...
{
  return accSensorState;
}

/**************************************************************************************************
* @fn          HalAccTurnOn
*
* @brief       Turn on the KXT19.
*
* @return      none
*/
void HalAccTurnOn(void)
{
  ...
  accSensorState = KXTI9_ON;
}

/**************************************************************************************************
* @fn          HalAccTurnOff
*
* @brief       Turn off the KXT19
*
* @return      none
*/
