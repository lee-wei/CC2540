/**
  @headerfile:    gap.h
  $Date: 2012-11-14 11:27:54 -0800 (Wed, 14 Nov 2012) $
  $Revision: 32182 $
...
// Proprietary
#define TGAP_SM_TIMEOUT               30  //!< SM Message Timeout (milliseconds). Default 30 seconds.
#define TGAP_SM_MIN_KEY_LEN           31  //!< SM Minimum Key Length supported. Default 7.
#define TGAP_SM_MAX_KEY_LEN           32  //!< SM Maximum Key Length supported. Default 16.
#define TGAP_FILTER_ADV_REPORTS       33  //!< Filter duplicate advertising reports. Default TRUE.
#define TGAP_SCAN_RSP_RSSI_MIN        34  //!< Minimum RSSI required for scan responses to be reported to the app. Default -127.

#if !defined ( TESTMODES )
  #define TGAP_AUTH_TASK_ID           35  //!< Task ID override for Task Authentication control (for stack internal use only)
  #define TGAP_PARAMID_MAX            36  //!< ID MAX-valid Parameter ID
#else
  #define TGAP_GAP_TESTCODE           35  //!< GAP TestCodes - puts GAP into a test mode
  #define TGAP_SM_TESTCODE            36  //!< SM TestCodes - puts SM into a test mode
