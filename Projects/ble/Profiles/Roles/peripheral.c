/**************************************************************************************************
  ...
  Revised:        $Date: 2012-11-14 13:15:48 -0800 (Wed, 14 Nov 2012) $
  Revision:       $Revision: 32186 $
...
//static uint16 gapRole_ConnectionHandle = INVALID_CONNHANDLE;          /* modify by liwei */
      ...
      case GAPROLE_PARAM_UPDATE_REQ:
        {
          ...
          {
            // Check the connection parameters versus the configured parameters
